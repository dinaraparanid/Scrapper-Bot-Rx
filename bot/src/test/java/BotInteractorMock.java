...
public final class BotInteractorMock implements BotInteractor {
    private record StateLessCommandAndPatcher(
        BotTextCommand<Object> command,
    ...
    private List<StateLessCommandAndPatcher> stateLessCommands() {
        return List.of(
            new StateLessCommandAndPatcher(new MockCommand("/help"), helpStatePatch),
            new StateLessCommandAndPatcher(new MockCommand("/list"), listStatePatch),
            new StateLessCommandAndPatcher(new MockCommand("/start"), startStatePatch),
            new StateLessCommandAndPatcher(new MockCommand("/track"), trackStatePatch),
            new StateLessCommandAndPatcher(new MockCommand("/untrack"), untrackStatePatch)
        );
    }
